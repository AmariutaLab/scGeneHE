...
scGeneHE requires 3 isolated environments: saige + saigeqtl, r, and python. It could be easily set up on any desktop computer or server platform, with estimated time of <1 hour.

1. Install [SAIGE](https://github.com/weizhouUMICH/SAIGE) and [SAIGE-QTL](https://github.com/weizhou0/qtl) using bioconda
```sh
    conda create -n saige -c conda-forge -c bioconda "r-base>=4.0" r-saige 'aryarm::r-saigeqtl'
    conda activate saige
```

2. Set up Python environment for bootstrapping
```sh
...
3. Set up R environment for h2 estimation and processing results
```sh
